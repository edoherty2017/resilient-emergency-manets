...
active window; the separately generated mesh catalog reports 764 RF observations, so
the pipeline/filter definitions must be reconciled before citing one total. \\
...
The count differences above come from independently generated artifacts with different
event/filter definitions; they are unresolved provenance differences, not sampling
uncertainty. In every analyzed 5-minute window of the descent interval (summit at 14:23 until the
