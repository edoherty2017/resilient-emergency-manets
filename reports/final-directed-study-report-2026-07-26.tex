...
after 2026-07-19 rest on SHA-256 digests recorded in dated documents and were
git-timestamped by commit \code{db06384} (branch
\code{trial2-field-campaign-2026-07}, 2026-07-26) together with the
registration artifacts themselves; all digests were re-verified against the
artifacts the same day. Scope is New Hampshire only.
...
numbers are bound to the archived release\_v1 artifacts. Post-2026-07-19 Trial~2 registrations were committed 2026-07-26 (\code{db06384}); their pre-commit provenance was in-doc SHA-256 digests, as disclosed in the claim-policy note. Authorization for a production fixed-relay deployment
