...
(\code{github.com/edoherty2017/resilient-emergency-manets-final}, branch \code{main} --- the canonical version of all material). Section~\ref{s:running} gives verified commands for running the
